...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <?php echo form_open('inbox/delete'); ?>
            <?php $this->load->view('modal/confirm'); ?>
            <div class="box-body no-padding <?php if(!$record) echo 'hide';?>">
              <div class="mailbox-controls">
                <!-- Check all button -->
                <div class="btn-group">
                  <button type="button" data-target="#search_modal" data-toggle="modal" class="btn btn-default btn-sm"><i class="fa fa-search"></i> Search</button>
            ...
            <?php if(isset($nodata)): ?>
                ...
                <p class="text-center text-danger" style="font-size:1.5em;">Woohoo! You've read all the messages in your inbox | <a href="#" onclick='location.reload(true); return false;'>Reload</a></p>
            <?php endif; ?>
                ...
                <div class="error-page">
                    ...
                    <div class="error-content">
                      ...
                      <p>
                        ...
                        Meanwhile, you may <a href="<?php echo base_url();?>inbox">refresh this page</a> or try using the <a href="#search_modal" data-toggle="modal">search again</a>.
                      </p>

                      <form class="search-form" method="POST" action="<?php echo base_url(); ?>inbox/search">
