...
<html>
  <head>
    ...
    <title>Messaging System | Register</title>
  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      <div class="register-logo">
        <a href="<?php echo base_url();?>"><b>Register</b>Panel</a>
      </div>
      ...
      <div class="register-box-body">
        ...
        <?php echo form_open('register'); ?>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="ID No." name="id_no" autocomplete="off">
